...
void* Master2Agent(void* info)
{
	...
	{		
		...
		{	
			...
			case 'u':
				pFile = fopen ( "Stowed_position.bin" , "rb" );
				...
				case 'e':
					{
						...
						tele_operating_flag = true;
						sam.speak("Use Keyboard to control Taurus", SAM::ASYNC);
...
int main(int    argc, char **argv)
{
	...
	int visualfeed_rc = pthread_create(&visual_feedback_thread,NULL,Visual_Feedback,(void*)x_server);
